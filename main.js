...
document.querySelector('.tecla_owwn').onclick = tocaSomGmd;

//Declaração/criação da função tocaSomZzz
function tocaSomZzz (){
    document.querySelector('#som_tecla_zzzz').play();
}
//chamada ou invocação da função tocaSomZzz ao clicar no botão
document.querySelector('.tecla_zzzz').onclick = tocaSomZzz;

//Declaração/criação da função tocaSomDia
function tocaSomDia (){
